...
import com.example.android.pdfrendererbasic.MainActivity1;
 ...
 */
public class PdfRendererBasicFragmentTests extends ActivityInstrumentationTestCase2<MainActivity1> {
    ...
    protected void setUp() throws Exception {
        ...
        mFragment = (PdfRendererBasicFragment) mActivity.getFragmentManager()
                .findFragmentByTag(MainActivity1.FRAGMENT_PDF_RENDERER_BASIC);
    }
